...
def generate(db):
    ...
    class Species(enum.Enum):
        ...
        HIGH_ELF_CALEDOR = "0301"  # High Elf Players Guide p. 54
        HIGH_ELF_ELLYRION = "0302"  # High Elf Players Guide p. 54
        HIGH_ELF_AVELORN = "0303"  # High Elf Players Guide p. 54
        HIGH_ELF_SAPHERY = "0304"  # High Elf Players Guide p. 54
        HIGH_ELF_EATAINE = "0305"  # High Elf Players Guide p. 54
        HIGH_ELF_TIRANOC = "0306"  # High Elf Players Guide p. 55
        HIGH_ELF_SHADOWLANDS = "0307"  # High Elf Players Guide p. 55
        HIGH_ELF_CHRACE = "0308"  # High Elf Players Guide p. 55
        HIGH_ELF_COTHIQUE = "0309"  # High Elf Players Guide p. 55
        HIGH_ELF_YVRESSE = "0310"  # High Elf Players Guide p. 55
        HIGH_ELF_SEA_ELF = "0311"  # High Elf Players Guide p. 57
        WOOD_ELF_DEFAULT = "0400"  # WFRP p. 28
        WOOD_ELF_EONIR_CITYBORN = "0401"  # Archives I p. 76
        WOOD_ELF_EONIR_FORESTBORN = "0402"  # Archives I p. 76
        WOOD_ELF_EONIR_YOUNGER = "0403"  # Archives I p. 76
    ...
    species_talents = {
        ...
        str(Species.HIGH_ELF_CALEDOR.value): [
            "Acute Sense - Sight",
            ["Commanding Presence", "Resolute"],
            "Night Vision",
            "Read/Write",
            ["Second Sight", "Strong-minded"],
        ],
        str(Species.HIGH_ELF_ELLYRION.value): [
            "Acute Sense - Sight",
            ["Animal Affinity", "Orientation"],
            "Night Vision",
            "Read/Write",
            ["Second Sight", "Sixth Sense"],
        ],
        str(Species.HIGH_ELF_AVELORN.value): [
            "Acute Sense - Sight",
            ["Attractive", "Artistic"],
            "Night Vision",
            "Read/Write",
        ...
        str(Species.HIGH_ELF_SAPHERY.value): [
            ["Acute Sense - Sight", "Bookish"],
            ["Coolheaded", "Savvy"],
            "Night Vision",
            "Read/Write",
            "Second Sight",
        ],
        str(Species.HIGH_ELF_EATAINE.value): [
            "Acute Sense - Sight",
            ["Dealmaker", "Savvy"],
            "Night Vision",
            "Read/Write",
        ...
        str(Species.HIGH_ELF_TIRANOC.value): [
            "Acute Sense - Sight",
            ["Coolheaded", "Hatred - Dark Elves"],
            "Night Vision",
            "Read/Write",
            ["Tenacious", "Sixth Sense"],
        ],
        str(Species.HIGH_ELF_SHADOWLANDS.value): [
            "Acute Sense - Sight",
            ["Coolheaded", "Tenacious"],
            "Hatred - Dark Elves",
            "Night Vision",
            "Read/Write",
            ["Rover", "Sixth Sense"],
        ],
        str(Species.HIGH_ELF_CHRACE.value): [
            "Acute Sense - Sight",
            ["Hardy", "Hunter's Eye"],
            "Night Vision",
            "Read/Write",
        ...
        str(Species.HIGH_ELF_COTHIQUE.value): [
            "Acute Sense - Sight",
            ["Sea Legs", "Hardy"],
            "Night Vision",
            "Read/Write",
        ...
        str(Species.HIGH_ELF_YVRESSE.value): [
            "Acute Sense - Sight",
            ["Coolheaded", "Stout-hearted"],
            "Night Vision",
            "Read/Write",
            ["Resolute", "Implacable"],
            ["Second Sight", "Sixth Sense"],
        ],
        str(Species.HIGH_ELF_SEA_ELF.value): [
            "Acute Sense - Sight",
            "Night Vision",
            ["Old Salt", "Sea Legs"],
            ["Orientation", "Sixth Sense"],
        ...
        str(Species.WOOD_ELF_EONIR_CITYBORN.value): [
            "Acute Sense - Sight",
            ["Hardy", "Second Sight"],
            "Night Vision",
            ["Read/Write", "Very Resilient"],
        ...
        str(Species.WOOD_ELF_EONIR_FORESTBORN.value): [
            "Acute Sense - Sight",
            ["Hardy", "Second Sight"],
            "Night Vision",
            ["Read/Write", "Very Resilient"],
        ...
        str(Species.WOOD_ELF_EONIR_YOUNGER.value): [
            "Acute Sense - Sight",
            ["Hardy", "Second Sight"],
            "Night Vision",
            ["Read/Write", "Very Resilient"],
