  ...
  <div class="careers">
    <b-container>
      ...
      <ElementList
        ...
        @createNew="modifyWh('career', 'create')"
        @modifyElement="modifyWh('career', $event)"
      />
...
const { copyWh, deleteWh, loadWhList, loaded, errors, listOfWh, addParamsToLocation, modifyWh } = useListWh(careerApi);
