...
type UserService interface {
	Get(ctx context.Context, c *auth.Claims, id string) (*User, *UserError)
	Exists(ctx context.Context, username string) (bool, *UserError)
	Create(ctx context.Context, u *User) (*User, *UserError)
	Update(ctx context.Context, c *auth.Claims, u *User) (*User, *UserError)
	UpdateCredentials(ctx context.Context, c *auth.Claims, currentPasswd string, u *User) (*User, *UserError)
	UpdateClaims(ctx context.Context, c *auth.Claims, u *User) (*User, *UserError)
	Delete(ctx context.Context, c *auth.Claims, currentPasswd string, id string) *UserError
	List(ctx context.Context, c *auth.Claims) ([]*User, *UserError)
